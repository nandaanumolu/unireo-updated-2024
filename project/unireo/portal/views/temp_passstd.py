...
"""
        ...
        return a
class emailvalidstd(View):
    def get(self,request):
        return render(request,'signup_forms/password_resetstd.html')
...
class tempvalidatorstd(View):
    def get(self,request):
        return render(request,'signup_forms/password_reset_confirmstd.html')
    def post(self,request):
