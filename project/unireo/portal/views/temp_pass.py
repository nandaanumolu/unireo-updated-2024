                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="http://localhost:8000/tempvalidator" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Hit here to reset</a>
                        </td>
                      </tr>
                    </table>
                  </td>
...
class emailvalid(View):
    ...
    def post(self,request):
        ...
        a1=University.IsExists(Email)
        if(a1):
            if(temp_pass.do(Email)):
                error_message="Email has been sent successfully pls check your mail to reset"
...
class tempvalidator(View):
    ...
    def post(self,request):
        ...
        print("done")
        university=University.objects.all().get(Email=Email)
        print(university)
        print(temp_pass)
        print(Password)
        ...
        print(temp_pass)
        print(a)
        print("efnkjevorejf;lsrmlvkrogtiegjlfdm;ovkfohglirngkf;mgorkf")
        if(temp_pass==a):
            print("nanda")
